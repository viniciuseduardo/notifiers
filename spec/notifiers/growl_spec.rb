...
describe Growl do
  ...
  describe '#sound' do
    ...
    it "should keep the sound" do
      @growl.sound('my_sound.wma')
      @growl.instance_variable_get(:@sound).should eql 'my_sound.wma'
    end

    it "should set the sound" do
      @growl.sound('doe.wma')
      @growl.instance_variable_get(:@sound).should eql 'doe.wma'
    end
  ...
  describe '#to_s' do
    ...
    it "should construct the command with title, message and sound" do
      command = @growl.message('DOh').title('Homer Simpson').sound("doe.wma").to_s
      command.should eql "growlnotify --title 'Homer Simpson' --message 'DOh' && afplay doe.wma"
    end
